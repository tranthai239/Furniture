              ...
              <table class="table table-striped">
                ...
                <tbody>
                  ...
                  while ($row = $result->fetch_assoc()) {
                    echo '<tr onclick="fillProductInfoForm( \'' . $row['ProductCode'] . '\', \'' . $row['NameProduct'] . '\', ' . $row['Price'] . ', ' . $row['DiscountPrice'] . ', \'' . $row['ImagePath'] . '\', \'' . $row['SKU'] . '\', \'' . $row['Color'] . '\', \'' . $row['Dimensions'] . '\', \'' . $row['Material'] . '\', \'' . $row['Policies'] . '\', \'' . $row['ImagePathSP1'] . '\', \'' . $row['ImagePathSP2'] . '\', ' . $row['Quantity'] . ');">';
                    echo '<td><input type="checkbox" onclick="selectCheckbox(this);"></td>';
            ...
            <div class="table-container">
              <table class="table table-striped">
                ...
                <tbody>
                  ...
                  while ($row = $result->fetch_assoc()) {
                    echo "<tr>";
                    echo "<td><input type='checkbox' class='productCheckbox' value='" . htmlspecialchars($row['ProductCode']) . "' 
            onclick='fillProductDemoForm(this)'></td>";
